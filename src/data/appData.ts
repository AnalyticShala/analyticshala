...
export const coursesData: Course[] = [
  ...
  },
  {
    ...
    slug: "sql-advanced",
    homepageOrder: 3,
    homepageTitle: "Modern SQL with AI",
    badge: "Core Skill",
    ...
    desc: "Modern SQL development with AI integration - from database fundamentals to production-grade analytics.",
    category: "Data Analytics",
    categoryLabel: "SQL",
    bannerImage:
    ...
    skills: [
      ...
      "AI-assisted SQL (ChatGPT / Copilot)",
      "Security & production practices",
      "SQL for analytics, ML & cloud",
    ],
    outcomes: [
      "Design and build production-grade databases",
      "Write advanced multi-table queries and analytics",
      "Use AI tools to accelerate SQL development",
      "Implement secure, transactional applications",
      "Build AI-ready data pipelines",
    ],
    regFee: "₹500",
    price: "₹5,999",
    originalPrice: "₹8,999",
    nextBatch: "June 13, 2026",
    batchType: "Weekend Batch (Sat & Sun, 09:00 AM - 11:00 AM)",
    instructor: "Faizan Ansari",
    includes: [
      "9 weeks of live weekend sessions",
      "Hands-on SQL Server practice",
      "Real-world business case studies",
      "AI integration with ChatGPT / Copilot",
    ...
    whoIsItFor: [
      ...
      "Backend developers",
      "Beginners moving into data",
    ],
    curriculum: [
      {
        week: "Week 1",
        title: "Introduction to Databases & RDBMS Fundamentals",
        topics: [
          "What is DBMS & RDBMS",
          "Database architecture basics",
          "Schema, tables, rows, columns",
          "Metadata concepts",
          "Keys & constraints",
          "Relationships & ER diagrams",
          "ACID properties overview",
          "Real-world database examples",
          "Practical: Designing simple ER diagrams",
        ],
      },
      {
        week: "Week 2",
        title: "SQL Server Setup & Environment",
        topics: [
          ...
          "Practical: SQL Server setup",
          "Practical: Creating your first database",
        ],
      },
      {
        week: "Week 3",
        title: "DDL Commands & Database Design",
        topics: [
          "CREATE, ALTER, DROP",
          "TRUNCATE",
          ...
          "Practical: Creating real-world tables",
          "Practical: Building a mini database schema",
        ],
      },
      {
        week: "Week 4",
        title: "DML Commands & Query Logic (with AI Integration)",
        topics: [
          ...
          "Operators, expressions & CASE statements",
          "AI: ChatGPT & Copilot for SQL generation",
          "AI: Prompt engineering for SQL",
          "AI: Validating AI-generated SQL",
          "AI: AI-assisted debugging",
          "Practical: Writing business queries",
        ],
      },
      {
        week: "Week 5",
        title: "Multi-table Queries & Data Analysis",
        topics: [
          ...
          "Practical: Sales & customer analysis queries",
        ],
      },
      {
        week: "Week 6",
        title: "Transactions & Concurrency Management",
        topics: [
          "Transactions in SQL",
          ...
          "Practical: Banking transaction examples",
          "Practical: Concurrent update scenarios",
        ],
      },
      {
        week: "Week 7",
        ...
        topics: [
          ...
          "AI-assisted stored procedure generation",
          "Query optimization basics",
          "Practical: Automated auditing system",
          "Practical: Employee salary processing procedures",
        ],
      },
      {
        week: "Week 8",
        title: "Security, Permissions & Production Practices",
        topics: [
          ...
          "Practical: Creating users & permissions",
          "Practical: Role-based access setup",
        ],
      },
      {
        week: "Week 9",
        title: "SQL for AI, Analytics & Modern Applications",
        topics: [
          "SQL in data analytics",
          "SQL for machine learning datasets",
          "Data cleaning with SQL",
          "SQL + Python integration",
          "SQL in AI applications",
          "Modern data pipelines overview",
          "Intro to cloud databases (Azure / AWS)",
          "Mini project: AI-ready customer analytics database",
        ],
      },
    ],
  },
...
export const teamData: TeamMember[] = [
  ...
  },
  {
    ...
    college: "ISB Student",
    image: "/assets/hobbies/dev_2.jpg",
    bio: "Data Science & AI Trainer with 10+ years of industry experience. Has trained 500+ professionals at Fortune 500 companies.",
    social: [
      {
